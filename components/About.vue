<template>
  <section
    class="bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 py-20 px-4 overflow-hidden transition-colors duration-500">
